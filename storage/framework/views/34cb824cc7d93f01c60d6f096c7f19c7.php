            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border-2 border-dashed border-purple-300">
                        ...
                        <p class="text-sm text-gray-600 mb-3"><?php echo e(__('Upload a document (PDF, DOCX, TXT) and AI will read it to generate slides based on its content.')); ?></p>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <span id="file-name" class="text-sm text-gray-600 italic"><?php echo e(__('No file chosen')); ?></span>
                    ...
                    <form id="slide-generator-form" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="topic" name="topic" required
                                   ...
                                   placeholder="<?php echo e(__('e.g., Introduction to Machine Learning (or leave empty if uploading document)')); ?>">
        ...
        documentUpload.addEventListener('change', function(e) {
            ...
            if (files.length > 0) {
                ...
                if (totalSize > 50 * 1024 * 1024) {
                    alert('<?php echo e(__('Total file size must be less than 50MB')); ?>');
                    e.target.value = '';
                    return;
                }
                ...
                topicInput.placeholder = '<?php echo e(__('Optional - AI will extract from document')); ?>';
            }
        });
        
        clearFileBtn.addEventListener('click', function() {
            documentUpload.value = '';
            fileName.textContent = '<?php echo e(__('No file chosen')); ?>';
            clearFileBtn.classList.add('hidden');
            documentPreview.classList.add('hidden');
            document.getElementById('file-list').innerHTML = '';
            topicInput.required = true;
            topicInput.placeholder = '<?php echo e(__('e.g., Introduction to Machine Learning (or leave empty if uploading document)')); ?>';
        });
...
<?php /**PATH C:\Users\HP\OneDrive\文档\GitHub\Ketupat-Labs\resources\views/ai-generator/slides.blade.php ENDPATH**/ ?>