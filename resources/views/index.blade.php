        ...
        <div class="container">
            <div class="about-content">
                ...
                <div class="about-image">
                    <img src="{{ asset('assets/images/ComputerImage.png') }}" alt="About Platform">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <h3><img src="{{ asset('assets/images/LOGOCompuPlay.png') }}" alt="CompuPlay Logo" class="footer-logo" onerror="this.onerror=null; this.src='{{ asset('assets/images/LOGOCompuPlay.svg') }}'"></h3>
