            ...
            @if($isTeacher)
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form method="GET" action="{{ route('activity.index') }}" class="flex items-center gap-4">
                        ...
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('activity.index', array_merge(request()->all(), ['month' => $prevMonth, 'year' => $prevYear])) }}"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        ← Sebelum
                                    </a>
                                    <a href="{{ route('activity.index', array_merge(request()->all(), ['month' => date('n'), 'year' => date('Y')])) }}"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        Hari Ini
                                    </a>
                                    <a href="{{ route('activity.index', array_merge(request()->all(), ['month' => $nextMonth, 'year' => $nextYear])) }}"
                                        class="px-3 py-1 text-sm border rounded hover:bg-gray-50 text-gray-600 no-underline">
                                        Seterusnya →
                                    </a>
                                </div>
